...
@XmlRootElement(name = "BookshelfItemsType")
public class BookshelfItemsType {

    @XmlElement(nillable = true)
    protected List<BookshelfItemsType.Item> item;
     ...
     * {@link BookshelfItemsType.Item }
     * 
     * 
     */
    public List<BookshelfItemsType.Item> getItem() {
        if (item == null) {
            item = new ArrayList<BookshelfItemsType.Item>();
        }
        return this.item;
    }
