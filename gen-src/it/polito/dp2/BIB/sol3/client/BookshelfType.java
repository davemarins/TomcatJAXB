...
@XmlRootElement(name = "BookshelfType")
public class BookshelfType {

    @XmlElement(nillable = true)
    protected List<BookshelfType.Item> item;
     ...
     * {@link BookshelfType.Item }
     * 
     * 
     */
    public List<BookshelfType.Item> getItem() {
        if (item == null) {
            item = new ArrayList<BookshelfType.Item>();
        }
        return this.item;
    }
