...
public class BiblioResources {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Created", response = BookshelfType.class),
			@ApiResponse(code = 400, message = "Bad request"), })
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response createBookshelf(@ApiParam("The name to create a Bookshelf") @QueryParam("name") String name) {
		if (name == null || name.isEmpty() || name.equals(""))
			throw new BadRequestException();
		BookshelfType bookshelf = null;
		String uri = "";
		try {
			bookshelf = this.service.createBookshelf(name);
			if (bookshelf == null)
				throw new BadRequestException();
			uri = bookshelf.getSelf();
			return Response.created(new URI(uri)).entity(bookshelf).build();
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
	}
	...
	@GET
	@Path("/bookshelf")
	@ApiOperation(value = "searchBookshelves", notes = "search bookshelves with given keyword", response = BookshelvesType.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = BookshelvesType.class),
			@ApiResponse(code = 400, message = "Bad request"), })
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public BookshelvesType searchBookshelves(
			@ApiParam("The keyword to be used for the search") @QueryParam("keyword") @DefaultValue("") String keyword) {
		if (keyword == null || keyword.isEmpty() || keyword.equals(""))
			throw new BadRequestException();
		try {
			return this.service.searchBookshelf(keyword);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
	}
	...
	@ApiOperation(value = "getBookshelf", notes = "get bookshelf with given id", response = BookshelfType.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = BookshelfType.class),
			@ApiResponse(code = 400, message = "Bad request"), @ApiResponse(code = 404, message = "Not found"), })
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public BookshelfType getBookshelf(
			@ApiParam("The id to be used for the retrieve") @PathParam("bookshelfId") BigInteger bookshelfId) {
		if (bookshelfId == null || bookshelfId.equals(""))
			throw new BadRequestException();
		BookshelfType bt;
		try {
			bt = this.service.getBookshelf(bookshelfId, true);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
		if (bt == null)
	...
	@GET
	@Path("/bookshelf/{bookshelfId}/items")
	@ApiOperation(value = "getItemsInsideBookshelf", notes = "get items inside a bookshelf", response = Items.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = Items.class),
			@ApiResponse(code = 400, message = "Bad Request"), @ApiResponse(code = 404, message = "Not found"), })
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Items getItemsInsideBookshelf(
			@ApiParam("The id to be used for the retrieve of the bookshelf") @PathParam("bookshelfId") BigInteger bookshelfId) {
		if (bookshelfId == null || bookshelfId.equals(""))
			throw new BadRequestException();
		Items item = null;
		try {
			item = this.service.getItemsInsideBookshelf(bookshelfId);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
		if (item == null)
	...
	@PUT
	@Path("/bookshelf/{bookshelfId}/items")
	@ApiOperation(value = "addItemToBookshelf", notes = "add item to bookshelf")
	@ApiResponses(value = { @ApiResponse(code = 204, message = "No content"),
			@ApiResponse(code = 400, message = "Bad Request"), @ApiResponse(code = 403, message = "Forbidden"),
			@ApiResponse(code = 404, message = "Not Found"), })
	@Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public void addItemToBookshelf(
			@ApiParam("The id of the bookshelf") @PathParam("bookshelfId") BigInteger bookshelfId, Item item) {
		if (bookshelfId == null || bookshelfId.equals(""))
			throw new BadRequestException();
		int result = 0;
		try {
			result = this.service.addItemToBookshelf(bookshelfId, item);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
		if (result == -1)
	...
	@DELETE
	@Path("/bookshelf/{bookshelfId}/items/{itemId}")
	@ApiOperation(value = "removeItemFromBookshelf", notes = "remove item to bookshelf")
	@ApiResponses(value = { @ApiResponse(code = 204, message = "No content"),
			@ApiResponse(code = 400, message = "Bad Request"), @ApiResponse(code = 404, message = "Not Found"), })
	public void removeItemFromBookshelf(
			@ApiParam("The id of the bookshelf") @PathParam("bookshelfId") BigInteger bookshelfId,
			@ApiParam("The id of the item") @PathParam("itemId") BigInteger itemId) {
		if (bookshelfId == null || bookshelfId.equals("") || itemId == null || itemId.equals(""))
			throw new BadRequestException();
		int result = 0;
		try {
			result = this.service.removeItemFromBookshelf(bookshelfId, itemId);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
		if (result == -1)
	...
	@DELETE
	@Path("/bookshelf/{bookshelfId}")
	@ApiOperation(value = "deleteBookshelf", notes = "remove bookshelf")
	@ApiResponses(value = { @ApiResponse(code = 204, message = "No content"),
			@ApiResponse(code = 400, message = "Bad request"), @ApiResponse(code = 404, message = "Not Found"), })
	public void deleteBookshelf(
		...
		boolean result;
		try {
			result = this.service.removeBookshelf(bookshelfId);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
		if (!result)
	...
	@GET
	@Path("/bookshelf/{bookshelfId}/stats")
	@ApiOperation(value = "getBookshelfStats", notes = "get bookshelf with given id", response = Integer.class)
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = Integer.class),
			@ApiResponse(code = 400, message = "Bad request"), @ApiResponse(code = 404, message = "Not found"), })
	@Produces(MediaType.TEXT_PLAIN)
	public Integer getBookshelfStats(
			@ApiParam("The id to be used for the retrieve") @PathParam("bookshelfId") BigInteger bookshelfId) {
		if (bookshelfId == null || bookshelfId.equals(""))
			throw new BadRequestException();
		int result = -1;
		try {
			result = this.service.getTotalReadsOfBookshelf(bookshelfId);
		} catch (Exception e) {
			throw new InternalServerErrorException();
		}
		if (result < 0)
